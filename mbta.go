...
func (m *MBTA) vehicleImage(routeType, color string) (ic iconCache, err error) {
	...
	case `Commuter Rail`:
		...
		pop1 = `m8.15625,16.06249l13.68751,0l0,3.50001l-13.68751,0l0,-3.50001z`
		pop2 = `m13.15629,9.31241l3.68743,0l0,3.71247l-3.68743,0l0,-3.71247z`
	case `Ferry`:
		...
		pop1 = `m3.75003,22.62494l22.49994,0l0,3.50001l-22.49994,0l0,-3.50001z`
	case `Local Bus`:
		...
		pop1 = `m6.99999,17.68749l16.00001,0l0,4.12501l-16.00001,0l0,-4.12501z`
		pop2 = `m8.93755,4.62504l12.12489,0l0,2.4l-12.12489,0l0,-2.4z`
	case `Rapid Transit`:
		...
		pop1 = `m9.34374,19.12499l11.31251,0l0,3.50001l-11.31251,0l0,-3.50001z`
		pop2 = `m12.2813,4.00004l5.43739,0l0,2.4l-5.43739,0l0,-2.4z`
	case `The Ride`:
		...
		pop1 = `m6.00002,18.18746l17.99996,0l0,3.12501l-17.99996,0l0,-3.12501z`
	default:
		return ic, nil
	}
	...
	if `` != pop1 {
		canvas.Path(pop1, `style="fill:white;fill-opacity:0.8;"`)
	}
	if `` != pop2 {
		canvas.Path(pop2, `style="fill:white;fill-opacity:0.8;"`)
	}
