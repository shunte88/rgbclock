...
func (ls *LMSServer) vuPeak(dBfs [2]int32) {
	...
	level := [10]int32{-50, -40, -30, -24, -18, -12, -9, -6, -3, 0}
	...
	bs := `<svg width="162" height="40" xmlns="http://www.w3.org/2000/svg">
	     ...
	     <defs>
	       <g id="led">
	           ...
	           <rect x=".5" y=".5" width="6.5" height="4.5" fill="black" fill-opacity=".15" stroke-width=".2" stroke-opacity=".5" stroke-position="inside" stroke="darkgray"/>
	       </g>
