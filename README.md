...
The [Go binding] has been modified to expose the brightness capability.  The panel brightness is modified at dawn and dusk.  More details on the modification to follow.
