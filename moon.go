...
func (m *Moon) PhaseIcon(sw, sh int) (img draw.Image, err error) {
	...
	canvas.Path(`m108.27516,210.81657c-1.3504,-10.80513 -6.44946,-11.24919 -18.12884,-16.03732c14.56598,-3.74255 18.02777,-12.64935 12.08516,-23.48683c7.46002,7.73173 14.19221,5.508 22.80197,-8.00359c-5.21947,18.38783 8.57644,22.84642 25.6544,23.38799c-18.60823,6.15093 -23.01136,14.62107 -17.60719,25.04577c-8.50439,-5.66703 -16.28758,-10.25844 -24.80548,-0.90601l-0.00003,0z`, `style="fill:#c3e5e0;fill-opacity:0.4;"`)
	canvas.Gend()
	canvas.Gend()
