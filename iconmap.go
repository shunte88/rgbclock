...
func mapInit() {
	im := map[string]icon{
		...
		"icon-29": icon{filename: "wi-night-partly-cloudy", color: "linen", width: miW, height: miW, alpha: miAlpha, scale: miScale,
			shadow: true, popcolor: "red"}, //"steelblue"}, // partly cloudy (night)
		...
		"icon-32": icon{filename: "wi-day-sunny", color: "yellow", width: miW, height: miW, alpha: miAlpha, scale: miScale, shadow: true,
